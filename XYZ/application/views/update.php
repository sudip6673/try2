...
<table height="300px" width="200px" border="4px">
	...
	<tr>
		...
		<td><input type="text" value="<?php echo $row['mfgdate']?>" name="mfgdate"  ></td>
		<td><input type="text" value="<?php echo $row['expdate']?>" name="expdate"  ></td>
		<td><input type="text" value="<?php echo $row['regdate']?>" name="regdate"  ></td>
